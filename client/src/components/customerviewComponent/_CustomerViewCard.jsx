  ...
  return (
    <div className="bg-white shadow-md rounded-lg overflow-hidden">
      <div class="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow ">
        ...
        <p class="mb-3 font-semibold text-gray-800 text-lg">Tag : {tag}</p>
        <p class="mb-3 font-semibold text-gray-800 text-lg">Charge : {charge}</p>
        <a href={`/customerView/display/${_id}/${pointer}`} class="inline-flex items-center px-3 py-2 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
          Hire
