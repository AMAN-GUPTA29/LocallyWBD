    ...
    <div className="bg-white shadow-md rounded-lg overflow-hidden my-10">
      <div className="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow flex flex-row items-center gap-20">
        ...
        <div className="flex flex-col items-center justify-center ml-auto">
          <a href={`/customerView/display/${_id}/${pointer._id}`} className="inline-flex items-center px-4 py-2 text-xl font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
            Hire
